...
function Mac_RogueComboPointBarFrameMixin:CreateRogueComboPoint()
	local unit = "player"
	local powerType = 4
	self.maxComboPoints = UnitPowerMax(unit, powerType)
...
function Mac_RogueComboPointBarFrameMixin:UpdateRogueComboPointVisibility()
	local unit = "player"
	local powerType = 4
	local maxComboPoints = UnitPowerMax(unit, powerType)
...
function Mac_RogueComboPointBarFrameMixin:UpdateRogueComboPoint()
	local unit = "player"
	local powerType = 4
	local currentComboPoints = UnitPower(unit, powerType)
	local rogueComboPointPool = self.RogueComboPointPool
	...
	for i = 1, #rogueComboPointPool do
		...
		if i > currentComboPoints then
			rogueComboPoint.Texture:SetColorTexture(
				backgroundColor.r,
				backgroundColor.g,
				backgroundColor.b,
				backgroundColor.a
